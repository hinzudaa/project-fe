...
export default function LoginPage() {
  ...
  const inputCls =
    "w-full bg-transparent text-white px-0 py-1 text-base outline-none placeholder:text-white/40 flex-1 min-w-0";
  const labelCls =
    "block text-[11px] font-bold text-white/50 tracking-[0.08em] uppercase mb-2.5";
